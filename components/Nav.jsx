    ...
    <>
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-10">
          <div
            className={`flex items-center justify-between transition-all duration-500 ${
              scrolled
                ? "rounded-full px-6 py-3 bg-[rgba(5,7,15,0.6)] border border-[rgba(255,255,255,0.09)]"
                : "px-0 py-1.5"
            }`}
            style={scrolled ? { boxShadow: "0 8px 32px rgba(0,0,0,0.35)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" } : {}}
          >
            ...
            <nav className="hidden md:flex items-center gap-11">
              ...
              <a
                ...
                data-testid="nav-cta"
                className="inline-flex items-center gap-2.5 text-[13px] font-display px-[18px] py-[9px] rounded-[var(--r-md)] border border-[var(--rule-strong)] text-[var(--ink)] hover:text-[var(--cyan)] hover:border-[var(--cyan)] transition-all duration-300 hover:-translate-y-[1px]"
              >
                Let's talk
            ...
            <button
              ...
              className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-[var(--r-md)] border border-[var(--rule-strong)] bg-[rgba(5,7,15,0.55)] backdrop-blur-md text-[var(--ink)] hover:text-[var(--cyan)] hover:border-[var(--cyan)] transition-colors"
            >
          ...
          {!scrolled && (
            <div
              aria-hidden
              className="mt-5 h-px w-full bg-[var(--rule)]"
            />
          )}
        </div>
      </header>
      ...
      >
        <div className="h-full flex flex-col justify-center px-8" onClick={(e) => e.stopPropagation()}>
          <span className="eyebrow text-[var(--ink-muted)] mb-10">Menu</span>
          ...
          <div className="mt-14 pt-8 border-t border-[var(--rule-strong)] flex items-center justify-between">
            <button
              ...
              onClick={toggleReadingMode}
              aria-pressed={readingMode}
              data-testid="nav-mobile-reading-mode"
              className="reading-toggle"
            >
              <span className="r-dot" aria-hidden />
              Reading mode
